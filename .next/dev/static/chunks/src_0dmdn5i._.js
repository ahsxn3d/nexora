...
const AuthModal = ()=>{
    _s();
    const { isAuthModalOpen, closeAuthModal, signInPersonal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AuthModal, "Uuk95V8bXgg7L5E4+Ol5WUy7Fyg=", false, function() {
    return [
...
_s(AuthProvider, "DkAtetysgAlnRXONARz9f5ElHXU=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
