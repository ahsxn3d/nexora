...
// Validate ../../src/app/api/ai/adapt-plan/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/ai/adapt-plan">> = Specific
  const handler = {} as typeof import("../../src/app/api/ai/adapt-plan/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
